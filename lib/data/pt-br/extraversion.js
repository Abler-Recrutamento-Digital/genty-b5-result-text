module.exports = {
  domain: 'E',
  title: 'Extroversão',
  shortDescription: 'A extroversão é marcada pela sociabilidade e engajamento com o mundo externo.',
...
grupos gostam de falar, se destacar e chamar a atenção. Ao contrário, os 
...
você já é um grande nível de socialização.`
    },
    {
      ...
      text: `Sua pontuação para Extroversão é média, indicando que você 
...
aglomerações. Não são antissociais/antipáticos, apenas sentem mais 
...
muitas atividades ao mesmo tempo. Pessoas que tem pontuação baixa seguem 
