module.exports = {
  domain: 'N',
  title: 'Neuroticismo',
  shortDescription: 'Neuroticismo tendência a experiência de emoções negativas. ',
  ...
  facets: [
    {
      facet: 1,
      title: 'Ansiedade',
      text: `O tipo de pessoa que está sempre "em alerta". Sentem ansiedade e que 
algo perigoso está prestes a acontecer. A sensação de medo por vir em situações 
comuns ou específicas. Se sentem tensos, nervosos e inquietos. Pessoas com baixa 
pontuação para ansiedade geralmente não têm medo, são calmas e tranquilas.`
    },
    {
      facet: 2,
      title: 'Raiva',
      text: `As pessoas com alta pontuação nessa catgoria se sentem frustradas 
quando as coisas não vão do seu jeito e têm tendência a experimentar amargura e 
raiva. Gostam de ser tratados de forma justa e se sentem injustiçados quando 
estão sendo enganados. Pessoas com pontuação baixa dificilmente passam raiva.`
    },
    {
      facet: 3,
      title: 'Depressão',
      text: `Tendência a se sentir triste, abatido e desanimado. Pontuações 
altas identificam pessoas que têm dificuldade em iniciar atividades e propensão 
maior a experimentar sintomas depressivos, como perda de energia, dificuldade de 
concentração e problemas com o sono. Já as pessoas com pontuação baixa tendem a 
não sentir esses sentimentos depressivos. `
    },
    {
      facet: 4,
      title: 'Autoconsciência',
      text: `Indivíduos autoconscientes são mais sensíveis e se sentem 
desconfortáveis sobre o que os outros pensam deles. Frequentemente sentem 
vergonha e constrangimento. Sua preocupação com a rejeição e serem julgados 
faz com que eles se sintam tímidos e envergonhados. Têm medo exagerado de 
críticas e de que tirem sarro deles. Os que pontuam baixo para autoconsciência, 
por outro lado, não sofrem com sentimentos de perseguição ou que estão julgando 
eles e não se sentem nervosos em situações sociais.`
    },
    {
      facet: 5,
      title: 'Impulsividade',
...
por esse motivo costumam ser mais moderados. `
    },
    {
      ...
      text: `Os que pontuam alto nessa competência têm dificuldade em lidar com o 
estresse; dependência de outros para apoio. Estão mais propensos a passar por pânico, 
confusão e desamparo quando sob pressão ou estresse. Pessoas com pouca pontuação para 
vulnerabilidade se sentem mais equilibrados, confiantes e pensam com clareza quando 
passam por momentos de estresse.`
    }
  ]
}
