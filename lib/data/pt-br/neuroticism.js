module.exports = {
  domain: 'N',
  title: 'Neuroticismo',
  shortDescription: 'Neuroticismo é a tendência a sentir emoções negativas.',
...
específicos quando "em situações de perigo". Hoje a psicologia retrata o 
...
a experimentar emoções negativas intensamente e têm dificuldade em controlar 
...
tendem a não sentir esses sentimentos depressivos.`
    },
    {
      ...
      text: `Indivíduos autoconscientes são mais sensíveis e dão muita importância 
sobre o que os outros pensam deles. Sua preocupação com a rejeição e julgamento faz com 
que eles sintam vergonha, constrangimento e timidez com frequência. Têm medo exagerado 
de críticas e de que tirem sarro deles. Os que pontuam baixo para autoconsciência, por 
outro lado, não sofrem com sensação de que estão sendo perseguidos, ou julgados e não 
ficam nervosos em situações sociais.`
    },
    {
      facet: 5,
      title: 'Impulsividade',
