module.exports = {
  ...
  shortDescription: 'Pessoas criativas, apreciadores da arte, da beleza e que gostam do novo.',
  ...
  results: [
    {
      ...
      text: `Sua pontuação para Abertura à Experiência é baixa, indicando 
que você gosta de pensar em termos simples e claros. Te descrevem como prático e realista.`
    },
    {
      score: 'neutral', // do not translate this line
      text: `Sua pontuação para Abertura à Experiência é média, indicando que você 
...
mas não super intelectual.`
    },
    {
      ...
      text: `Sua pontuação para Abertura à Experiência é alta, indicando que você 
  ...
  facets: [
    {
      facet: 1,
      title: 'Fantasia',
      text: `Vida mental ativa, criativa e de forte imaginação. Para essas pessoas o 
